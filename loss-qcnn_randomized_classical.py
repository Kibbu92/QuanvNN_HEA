...
if __name__ == '__main__':
    ...
    NL  = [3,10,30]                                       # [ 3, 10, 30] Numero di Layer
    ...
    for k in range(len(NL)):
        ...
        for j in range(len(KNL)):
            ...
            for h in range(len(OPT)):
                ...
                SAVE_PATH = os.path.join('results', DATSET_NAME + '_no_Fully',  f'{NUM_LAYERS}_{KERNEL_SIZE}' , f'{OPT[h]}_{NUM_LAYERS}_{KERNEL_SIZE}')
                ...
                for m in range(5):
                    ...
                    # non_trainable_params = {"qcnn": {"gates": trainable_params["qcnn"].pop("gates")}, "full": trainable_params.pop("full")} # angles
                    # non_trainable_params = {"qcnn": {"gates": trainable_params["qcnn"].pop("gates")}} # angles + full
                    #non_trainable_params = {"qcnn": trainable_params.pop("qcnn")} # full
                    non_trainable_params = {"full": trainable_params.pop("full")} # angles
